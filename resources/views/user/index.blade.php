                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('users.destroy',$user->id) }}" method="POST">
                                                    ...
                                                    <a class="btn btn-sm btn-warning " href="{{ route('users.show',$user->id) }}"><i class="fa fa-fw fa-eye"></i> Enable</a>
                                                    <a class="btn btn-sm btn-warning " href="{{ route('users.show',$user->id) }}"><i class="fa fa-fw fa-eye"></i> Disable</a>
                                                    @csrf
                                                    @method('DELETE')
